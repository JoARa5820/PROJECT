...
fn_etc_bz <- function(REG_YYMM){
  ...
  write.csv(htw_input_fore, file = paste0(result_folder_route,'ETC_BZ/ETC_BZ_전망결과_',OPERATION_POINT,'.csv'), row.names = FALSE)
